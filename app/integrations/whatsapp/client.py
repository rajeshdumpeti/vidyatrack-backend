# --- Meta WhatsApp Cloud API (commented out, replaced by Twilio) ---
# import json
# import ssl
...
#     )
#     if missing:
#         return WhatsAppSendResult(success=False, provider_message_id=None,
#                                   status_code=0, provider_error_message=f"{missing} is not configured")
...
#             return WhatsAppSendResult(success=200 <= status_code < 300,
#                                       provider_message_id=provider_message_id, status_code=status_code)
...
#         return WhatsAppSendResult(success=False, provider_message_id=None,
#                                   status_code=exc.code, provider_error_code=provider_error_code,
#                                   provider_error_message=provider_error_message)
#     except URLError:
#         return WhatsAppSendResult(success=False, provider_message_id=None,
#                                   status_code=0, provider_error_message="network_error")
# --- End Meta WhatsApp Cloud API ---
